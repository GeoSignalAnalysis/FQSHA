...
import math
import numpy as np
from src.SeismicActivityRate import sactivityrate, momentbudget
...
class TestSeismicActivityRate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Calculate results once per test case
    ...
    def test_truncated_gr_behaviour(self):
        """Test Truncated Gutenberg Richter behavior"""
            ...
            with self.subTest(fault=fault_name):
                for field in expected_fields:
                    self.assertIn(field, fault_data,
                                  f"Missing '{field}' in fault {fault_name}")
    ...
    def test_output_consistency(self):
        ...
        try:
            ...
            self.fail(f"XML export failed with exception: {str(e)}")

    def test_morate_calculation(self):
        """Test moment rate calculations"""
